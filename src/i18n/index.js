...
export const translations = {
  'zh-CN': {
    ...
    nodeFilterSettings: '节点标题过滤',
    nodeFilterTip: '仅对 SingBox / Clash / Surge 生效。按节点标题匹配，支持关键词或正则，一行一个条件。',
    nodeFilterMode: '过滤模式',
    nodeFilterModeInclude: '白名单（只保留匹配节点）',
    nodeFilterModeExclude: '黑名单（排除匹配节点）',
    nodeFilterType: '匹配方式',
    nodeFilterTypeKeyword: '关键词',
    nodeFilterTypeRegex: '正则表达式',
    nodeFilterValues: '匹配条件',
    nodeFilterValuesPlaceholder: '一行一个条件\n例如：\n日本\n台湾\n韩国\n美国',
  ...
  'en-US': {
    ...
    nodeFilterSettings: 'Node Title Filter',
    nodeFilterTip: 'Applies to SingBox / Clash / Surge only. Matches node titles with keywords or regex, one condition per line.',
    nodeFilterMode: 'Filter Mode',
    nodeFilterModeInclude: 'Whitelist (keep matching nodes)',
    nodeFilterModeExclude: 'Blacklist (exclude matching nodes)',
    nodeFilterType: 'Match Type',
    nodeFilterTypeKeyword: 'Keyword',
    nodeFilterTypeRegex: 'Regular Expression',
    nodeFilterValues: 'Conditions',
    nodeFilterValuesPlaceholder: 'One condition per line\nExample:\nJapan\nTaiwan\nKorea\nUnited States',
  ...
  'fa': {
    ...
    nodeFilterSettings: 'فیلتر عنوان نود',
    nodeFilterTip: 'فقط برای SingBox / Clash / Surge اعمال می‌شود. بر اساس عنوان نود با کلمه کلیدی یا regex، هر خط یک شرط.',
    nodeFilterMode: 'حالت فیلتر',
    nodeFilterModeInclude: 'لیست سفید (فقط نودهای منطبق)',
    nodeFilterModeExclude: 'لیست سیاه (حذف نودهای منطبق)',
    nodeFilterType: 'نوع تطبیق',
    nodeFilterTypeKeyword: 'کلمه کلیدی',
    nodeFilterTypeRegex: 'عبارت منظم',
    nodeFilterValues: 'شرایط',
    nodeFilterValuesPlaceholder: 'هر خط یک شرط\nمثال:\nژاپن\nتایوان\nکره\nآمریکا',
  ...
  'ru': {
    ...
    nodeFilterSettings: 'Фильтр названий узлов',
    nodeFilterTip: 'Работает только для SingBox / Clash / Surge. Фильтрует по названию узла, поддерживает ключевые слова и regex, по одному условию на строку.',
    nodeFilterMode: 'Режим фильтра',
    nodeFilterModeInclude: 'Белый список (оставить совпавшие узлы)',
    nodeFilterModeExclude: 'Чёрный список (исключить совпавшие узлы)',
    nodeFilterType: 'Тип сопоставления',
    nodeFilterTypeKeyword: 'Ключевое слово',
    nodeFilterTypeRegex: 'Регулярное выражение',
    nodeFilterValues: 'Условия',
    nodeFilterValuesPlaceholder: 'Одно условие на строку\nНапример:\nJapan\nTaiwan\nKorea\nUnited States',
