...
export const GITHUB_REPO = 'https://github.com/DrayChou/sublink-worker';
export const GITHUB_API_RELEASES = 'https://api.github.com/repos/DrayChou/sublink-worker/releases/latest';
